...
## Maintenance  
* The Ingredient Exposure Table should be rewritten according to the cadence in which the Drug Exposures Table source is modified.  
...
# Table Outputs
1. Ingredient Exposure Table `drugExposureIngredientTable`: All observations in the OMOP CDM Drug Exposures table with an additional column `ingredient_concept_id` that maps the `drug_concept_id` to the RxNorm Ingredient in the OMOP Vocabulary  

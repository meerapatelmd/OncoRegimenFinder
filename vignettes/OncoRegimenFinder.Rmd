...
## Steps  
1. All the Drug Exposure Table `drug_concept_ids` are mapped to their RxNorm Ingredient and stored in a Ingredient Exposures Table. 
...
1. A separate Vocabulary Table is created that maps the HemOnc ontology Regimen Concept Name from the OMOP Vocabulary Concept Table to string aggregates of the individual Component Concept Names derived by the algorithm.  

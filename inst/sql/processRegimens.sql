...
---Grouping by person_id, drug_exposure_id, ingredient_name, and ingredient_start_date, and joining back to the same table to
...
WITH add_groups AS (
  ...
  GROUP BY r1.person_id, r1.drug_exposure_id, r1.ingredient_name, r1.ingredient_start_date
),
...
regimens_to_keep AS (
SELECT rs.person_id, gs.drug_exposure_id, gs.ingredient_name, rs.ingredient_start_date_new as ingredient_start_date
FROM regimens rs
...
UNION
SELECT person_id, drug_exposure_id, ingredient_name, ingredient_start_date

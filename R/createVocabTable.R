...
#'  \code{\link[rubix]{group_by_unique_aggregate}},\code{\link[rubix]{arrange_by_nchar}},\code{\link[rubix]{filter_first_row}}
...
#' @importFrom rubix group_by_unique_aggregate arrange_by_nchar filter_first_row
